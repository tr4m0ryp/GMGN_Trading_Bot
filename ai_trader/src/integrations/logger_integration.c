 ...
 * @brief Implementation of logger_c integration
 *
 * Provides callbacks for the token_tracker in logger_c to notify
 * the ai_trader when new tokens pass filter criteria.
 *
 * Integration modes:
 * 1. Shared library linking (compile logger_c with ai_trader)
...
#define TOKEN_LIST_DIR          "../logger_c/tokens"
